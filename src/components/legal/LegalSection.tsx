/*
File: LegalSection.tsx
Description: This shows legal informations for the application.
*/

import DescriptionSection from "@/components/ui/title/DescriptionSection";
    ...
    <section id="legal" className="container contx conty mx-auto">
      ...
      <div className="container space-y-8">
        ...
        >
          ...
          <ul>
            ...
            <li>
              <p className="mt-4 text-base text-gray-700">
                ...
                "We", "Us" or "Our" in this Agreement) refers to MaiaLabs.
              </p>
            </li>
            <li>
              <p className="mt-4 text-base text-gray-700">
          ...
          <ul>
            <li>
              <p className="mt-4 text-base text-gray-700">Email address</p>
            </li>
            <li>
              <p className="mt-4 text-base text-gray-700">Usage Data</p>
            </li>
          </ul>
          <h4>Usage Data</h4>
          <p className="mt-4 text-base text-gray-700">
